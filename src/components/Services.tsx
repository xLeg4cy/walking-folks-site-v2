...
const Services = () => {
  ...
  return <div id="services" className="py-24 bg-background text-foreground dark:bg-gray-900">
      <div ref={servicesRef} className="section max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => <div key={index} className="group bg-white dark:bg-gray-800 p-8 rounded-2xl border border-gray-100 dark:border-gray-700 hover:border-brand-purple-light dark:hover:border-brand-purple-light transition-all hover:-translate-y-1 hover:shadow-lg relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-3">
                  {service.features.map((feature, fIndex) => <li key={fIndex} className="text-sm text-muted-foreground dark:text-gray-400 flex items-center group">
