          ...
          >
              ...
              <div className="flex flex-col lg:flex-row">
                <div className="lg:w-1/3 flex items-center justify-center p-8 bg-gray-50 dark:bg-gray-800/80">
                  ...
                  >
                    ...
                    <img 
                      src={visiblePartners[0].logo} 
                      alt={visiblePartners[0].name} 
                ...
                <div className="lg:w-2/3 p-6 lg:p-8">
                  ...
                  <CardFooter className="p-0 pt-2">
                    <a 
                      href={visiblePartners[0].website}
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center text-[#4338CA] hover:text-[#564ED1] dark:text-brand-purple-light dark:hover:text-white transition-colors"
                    >
            ...
            <div className="text-center mt-10">
              <p className="text-sm text-muted-foreground dark:text-gray-400 italic">
                Interested in becoming a strategic partner? <a href="#contact" className="text-[#4338CA] hover:underline dark:text-brand-purple-light">Contact us</a> to explore collaboration opportunities.
              </p>
            </div>
          </motion.div>
        ) : (
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    />
                    {partner.featured && (
                      <Badge className="bg-[#4338CA]">Featured</Badge>
                    )}
                  </div>
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-flex items-center text-[#4338CA] hover:text-[#564ED1] dark:text-brand-purple-light dark:hover:text-white text-sm"
                  >
                    Learn more
